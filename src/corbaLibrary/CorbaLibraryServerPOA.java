 ...
 */
public abstract class CorbaLibraryServerPOA extends org.omg.PortableServer.Servant
        implements CorbaLibraryServerOperations, org.omg.CORBA.portable.InvokeHandler
{
    public CorbaLibraryServer _this()
    {
        return CorbaLibraryServerHelper.narrow(_this_object());
    }

    public CorbaLibraryServer _this(org.omg.CORBA.ORB orb)
    {
        return CorbaLibraryServerHelper.narrow(_this_object(orb));
    }
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_setDuration(
        ...
        boolean _arg_result = setDuration(arg0_in, arg1_in, arg2_in);
