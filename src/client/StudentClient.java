...
public class StudentClient 
{
   ...
   public StudentClient(String institution)
   {
      ...
      try {
		frontend = (FrontEndInterface) Naming.lookup("rmi://localhost:"+ findServer(institution));
   ...
   public boolean createAccount() throws RemoteException, IOException
   {
      ...
      if(frontend.createAccount(student.getFirstName(), student.getLastName(), student.getEmailAddress(), student.getPhoneNumber(), student.getUserName(), student.getPassword(), student.getEducationalIns())=="true") 
      {
   ...
   public void reserveBook() throws RemoteException
   {
	  ...
	  if(frontend.reserveBook(student.getUserName(),student.getPassword(),bookName,authorName)== "true") {
   ...
   public static void main(String args[])
   {
      ...
      aStudent = new StudentClient("LibraryServerFrontend");
   ...
   public void demoCreateAccount(String firstName, String lastName, String emailAddress,
	   ...
	   try {
		frontend.createAccount(firstName, lastName, emailAddress, phoneNumber, username, password, eduInstitution);
	   } catch (RemoteException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	   }
   ...
   public void demoReserveBook(String username, String password, String bookName, String authorName) {
	   try {
		frontend.reserveBook(username, password, bookName, authorName);
	   } catch (RemoteException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	   }
